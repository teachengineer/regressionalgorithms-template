...
# -*- coding: utf-8 -*-
"""
Created on Sun Sep 26 20:54:16 2021

@author: rodin
"""

#Aşağıda, Python ile şimdiye kadar yazdığımız regresyon algoritmalarının şablonunu bulabilirsiniz: 
...
#tek bir kolondan oluşan bağımlı değişkenleri ise y ismine bir data frame içerisinde duracağı kabulü yapılmıştır.
...
#şimdiye kadar elde ettiğimiz yapıya çok benzer şekilde, sklearn kütüphanesi içerisinden bir sınıf olarak RandomForestRegressor eklemiş (import) ve bu sınıftan da 
#ürettiğimiz nesne ile fit() ve predict() metotlarını kullanarak makine öğrenmesini gerçekleştirmiştir. 
